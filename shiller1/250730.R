f250727aFun() #ASC  All Sale Coco slow cowrite
f250728aFun() #SPP  Sale Price Pair slow // step
...
xx1 <- f250728ad[1:1000000,.(idhash,t0,t1,p0,p1)]
xx2 <- x101
system.time(x3 <- f250727b(xx1,xx2))
...
x_test[,order(t1)]
f250727b(x_test,tt)[order(action,t0)]




f250727b(x1[,.(idhash=id,t0,t1,p0,p1)],x101)
