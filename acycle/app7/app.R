...
#-----------------------------------------------------------------------------UI
ui <- 
  page_navbar(#---------------------------------------------page-navbar-spans-ui
    sidebar = sidebar(#------------------------------------------index-sidebar-v
      Title="Sidebar",
      layout = c("customrc6",
                 "nationalrc6",
                 "localrc3",
    ...
    #------------------------------------------------------start-all-non-sidebar
    #footer = tags$div("powered by Acycle"),
    title = "Acycle",
    selected = "Index",
    collapsible = TRUE,
    theme = bslib::bs_theme(),
    nav_panel(#------------------------------------nav-panel-toolbar-1/3-Index-v
      title = "Index",
      tabsetPanel(#-------------------------------------------tabsetPanel-tabs-v
        id="tabs",
        nav_panel(#----------------------------------------------------nav_panel
          title = "Index",
          conditionalPanel(#start conditional
            condition = "input.intybu == 'n'",
        ...
        nav_panel(#-----------------------------------------index-accuracy-start
          title = "Accuracy",
          grid_container(
            layout = c(
              "inacta" #accuracy
      ...
      )#---------------------------------------------------end tabsetPanel tabs^
    ),#----------------------------------------end-nav-panel-toolbar-1/3-Index-^
    nav_panel(#------------------------------------nav-panel-toolbar-2/3-Cycle-v
      title = "Cycle",
      grid_container(
        layout = c(
          "cyse cyta"
        ...
        grid_card(
          ...
          card_body(
            tabsetPanel(
              ...
              # nav_panel Factor ----
              nav_panel(#----------------------------------nav_panel Factor/beta
                title = "Factor/beta",
                grid_container(
                  layout = c(
                    "cyfbar cyfbxt",
              ...
              nav_panel(#--------------------------------nav-panel-Time-series-v
                title = "Time-series",
                grid_container(
                  layout = c(
                    "area0",
              ...
              )#-----------------------------------------nav-panel-Time-series-^
              ,
              # NAV1 ----
              nav_panel(#-----------------------------------nav-panel-Download-v
                title = "Download",
                grid_container(
                  layout = c(
                    "cydofa",
              ...
              )#----------------------------------------end-nav-panel-Download-^
              # NAV2 ----
            )
          )
        )
      )
    )#-----------------------------------------end-nav-panel-toolbar-2/3-Cycle-^
    ,
    nav_panel(#-------------------------------------nav-panel-toolbar-3/3-Data-v
      title = "Data",
      grid_container(
        layout = c(
    ...
    )#------------------------------------------end-nav-panel-toolbar-3/3-Data-^
  )#---------------------------------------------------end-page-navbar-spans-ui^
#-------------------------------------------------------------------------server
#-------------------------------------------------------------------------server
server <- function(input, output) {
  ...
  # Rincuwi ----
  Rincuwi <- #note that the comment above is an 'identifier' and enables collapse SO 66363530
    eventReactive(
      eventExpr=
        list(
