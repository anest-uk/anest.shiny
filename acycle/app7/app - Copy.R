...
ui <- page_navbar( #UI  ---------------------------------------------------------
                   ...
                   nav_panel(title = "Index",#toolbar 1/3: index ----
                             tabsetPanel(id="tabs",# ----
                                         ...
                                         nav_panel(title = "Accuracy",#tab: accuracy-----------------------------------------
                                                   grid_container(
                                                     layout = c(
                                                       "inacta" #accuracy
                                                       # "inacth area1 area2",
                                         ...
                                         nav_panel(title = "Download",#tab: download -----------------------------------------------
                                                   grid_container(
                                                     layout = c(
                                                       "indocu",
                                                       "indona",
                   ...
                   nav_panel(title = "Cycle",#toolbar 2/3: cycle ------------------------------------
                             grid_container(
                               layout = c(
                                 "cyse cyta"
                               ),
                               ...
                               grid_card(
                                 ...
                                 card_body(
                                   tabsetPanel(
                                     nav_panel(title = "Value/Momentum",#tab: cycle ----------------------------------------
                                               grid_container(
                                                 layout = c(
                                                   "cyvmcc cyvmcr",
                                                   "cyvmci cyvmct"
                                     ...
                                     nav_panel(title = "Time-series",#tab: time-series --------------------------------
                                               grid_container(
                                                 layout = c(
                                                   "area0",
                                                   "area1"
                   ...
                   ,
                   nav_panel(title = "Data", #toolbar 3/3: data -------
                             grid_container(
                               layout = c(
...
server <- function(input, output) {#server                                   -------------------------------------
  ...
  output$innach <- render_gt( #national characteristics table         2.2    ----
                              gt::gt(x.nat.t4)%>%
                                cols_label(
                                  frac = gt::html('Fraction<br>properties'),
                                  R2rsi = gt::html("RSI R<sup>2</sup>"),
