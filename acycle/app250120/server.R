...
server <-
  function(input, output) {
    ...
    estdtxR <- #----112 x(t)
      eventReactive(list(estdtcuR(), estdtaR(), geocuX = geocuR())
                    , {
    ...
    observe({
      ...
      if (verbose) {
        print('X - exit observe updateTreeInput')
      }
