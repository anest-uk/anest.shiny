...
#x00$rss[nxdR,on=c(nx='nx')]


#xrssR <- x00$rss[type=='L'][unique(geoR[rc3==rc3xR,.(nx,des=lab,ltile)]),on=c(nx='nx')]
#xestdt <- x00$estdt[type=='L'][unique(geoR[rc3==rc3xR,.(nx,des=lab,ltile)]),on=c(nx='nx')]



#----1.1 #require geoplus[type=='L']
