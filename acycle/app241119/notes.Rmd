...
- time-series summary: outline target district orange on map
...
- minor UI limitation: custom index 'district picker' not implemented, hardcoded custom=target district  
